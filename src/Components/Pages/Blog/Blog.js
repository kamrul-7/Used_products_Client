                ...
                <div >
                    ...
                    <div className="max-w-sm bg-white border-gray-200 border-2 rounded shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg">
                        ...
                        <div className="p-5">
                            ...
                            <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-emerald-800  rounded-lg hover:bg-gray-600  focus:ring-4 mt-4 focus:outline-none focus:bg-emerald-400  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Read more
                ...
                <div>
                    ...
                    <div className="max-w-sm bg-white border-gray-200 border-2 rounded shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg">
                        ...
                        <div className="p-5">
                            ...
                            <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-emerald-800 mt-4 rounded-lg hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Read more
                                <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" ></path></svg>
                            </a>
                        </div>
                ...
                <div>
                    ...
                    <div className="max-w-sm bg-white border-gray-200 border-2 rounded shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg">
                        ...
                        <div className="p-5">
                            ...
                            <a href="#" className="inline-flex items-center mt-4 px-3 py-2 text-sm font-medium text-center text-white bg-emerald-800  rounded-lg hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Read more
                                <svg aria-hidden="true" className="w-4 h-4 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" ></path></svg>
                            </a>
                        </div>
