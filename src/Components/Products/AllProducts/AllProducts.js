        ...
        <div>
            <div>
                <div className="card w-96 h-96 bg-base-100 shadow-xl">
                    <figure><img className="h-44" src={img} alt="Product" /></figure>
                   ...
                   <div className="mx-4">
                        <label
                            ...
                            className=" click text-center px-4 py-2 rounded-md text-white hover:bg-gray-800 font-semibold">Buy Now</label>
                    </div>
